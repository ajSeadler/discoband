...
const HeroSection = styled(Paper)(({ theme, isHovered }) => ({
  display: 'flex',
  ...
  textAlign: 'center',
  padding: '20px',
  background: isHovered ? theme.palette.common.white : (theme.palette.error && theme.palette.error.main), // Check if theme.palette.error is defined
